...
You can find available NAT64 Prefixes [in here](https://github.com/Nexuspt753/BPB-Worker-Panel/blob/main/docs/NAT64Prefixes.md), which lists IPs by region and ISP.
